...
export default function ExtendedSurvey() {
  ...
  const questions = [
    { id: "gender", title: "Please specify your gender:", options: ["Male", "Female"] },
    { id: "age", title: "How old are you?" },
    { id: "active", title: "Are you physically active (≥3 times a week)?", options: ["Yes", "No"], icon: true },
    { id: "smoke", title: "Do you smoke cigarettes or e-cigarettes?", options: ["Yes", "No"] },
    { id: "height", title: "How tall are you? (cm)" },
    { id: "weight", title: "Please specify your weight (kg):" },
    { id: "alcohol", title: "Do you consume alcohol?", options: ["Yes", "No"] },
    { id: "conditions", title: "Do you have any chronic health conditions?", options: ["Yes", "No"] },
    { id: "family", title: "Does anyone in your family have a history of serious illness?", options: ["Yes", "No"] },
    { id: "symptoms", title: "Have you experienced any unusual symptoms recently?", options: ["Yes", "No"] },
  ];

  const handleFinish = () => navigate("/calendar");
  ...
  return (
    ...
    >
      <div className="w-full max-w-[710px] py-20 px-8">
        ...
        {questions.map((q) => (
          <div key={q.id} className="bg-white/90 shadow-xl rounded-[50px] p-8 mb-8 relative">
            <h2 className="text-[32px] font-extrabold text-[#13313f] mb-6">{q.title}</h2>
            ...
            {q.options ? (
              ...
              <input type="number" min="0" className="border-2 border-[#186f9b] rounded px-4 py-2 ml-4" />
            )}
